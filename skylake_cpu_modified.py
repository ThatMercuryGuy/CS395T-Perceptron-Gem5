...
class SkylakePerceptronBP(PerceptronBP):
    btb = SimpleBTB(numEntries=512, tagBits=19)
    ras = ReturnAddrStack(numEntries=32)
    indirectBranchPred = IndirectPred()
...
# 8KB Budget Wrapper
class SkylakePerceptron8KB(Perceptron8KB):
    btb = SimpleBTB(numEntries=512, tagBits=19)
    ras = ReturnAddrStack(numEntries=32)
    indirectBranchPred = IndirectPred()

# 16KB Budget Wrapper
class SkylakePerceptron16KB(Perceptron16KB):
    btb = SimpleBTB(numEntries=512, tagBits=19)
    ras = ReturnAddrStack(numEntries=32)
    indirectBranchPred = IndirectPred()

# 32KB Budget Wrapper
class SkylakePerceptron32KB(Perceptron32KB):
    btb = SimpleBTB(numEntries=512, tagBits=19)
    ras = ReturnAddrStack(numEntries=32)
    indirectBranchPred = IndirectPred()

class SkylakePerceptron4KB_Theta68(Perceptron4KB_Theta68):
    btb = SimpleBTB(numEntries=512, tagBits=19)
    ras = ReturnAddrStack(numEntries=32)
    indirectBranchPred = IndirectPred()

class SkylakePerceptron4KB_Theta20(Perceptron4KB_Theta20):
    btb = SimpleBTB(numEntries=512, tagBits=19)
    ras = ReturnAddrStack(numEntries=32)
    indirectBranchPred = IndirectPred()

class SkylakePerceptron4KB_Theta150(Perceptron4KB_Theta150):
    btb = SimpleBTB(numEntries=512, tagBits=19)
    ras = ReturnAddrStack(numEntries=32)
    indirectBranchPred = IndirectPred()

class SkylakeBiModeBP(BiModeBP):
    btb = SimpleBTB(numEntries=512, tagBits=19)
    ras = ReturnAddrStack(numEntries=32)
    indirectBranchPred = IndirectPred()
